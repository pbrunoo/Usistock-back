...
exports.UpdateOrcamentoService = void 0;
const common_1 = require("@nestjs/common");
const orcamento_repository_1 = require("../respositories/orcamento.repository");
let UpdateOrcamentoService = class UpdateOrcamentoService {
    constructor(orcamentoRepository) {
        this.orcamentoRepository = orcamentoRepository;
    }
    async update(orcamentoId, updateOrcamentoRequest) {
        try {
...
UpdateOrcamentoService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [orcamento_repository_1.OrcamentoRepository])
], UpdateOrcamentoService);
exports.UpdateOrcamentoService = UpdateOrcamentoService;
//# sourceMappingURL=update-orcamento.service.js.map