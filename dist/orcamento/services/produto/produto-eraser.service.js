...
exports.ProdutoEraserService = void 0;
const common_1 = require("@nestjs/common");
const orcamento_repository_1 = require("../../respositories/orcamento.repository");
let ProdutoEraserService = class ProdutoEraserService {
    constructor(orcamentoRepository) {
        this.orcamentoRepository = orcamentoRepository;
    }
    async eraser(orcamentoId, produtoId) {
...
ProdutoEraserService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [orcamento_repository_1.OrcamentoRepository])
], ProdutoEraserService);
exports.ProdutoEraserService = ProdutoEraserService;
//# sourceMappingURL=produto-eraser.service.js.map