...
exports.UpdateFuncionarioService = void 0;
const common_1 = require("@nestjs/common");
const funcionario_repository_1 = require("../repositories/funcionario.repository");
let UpdateFuncionarioService = class UpdateFuncionarioService {
    constructor(funcionarioRepository) {
        this.funcionarioRepository = funcionarioRepository;
    }
    async update(funcionarioId, updateFuncionarioRequest) {
        try {
...
UpdateFuncionarioService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [funcionario_repository_1.FuncionarioRepository])
], UpdateFuncionarioService);
exports.UpdateFuncionarioService = UpdateFuncionarioService;
//# sourceMappingURL=update-funcionario.service.js.map