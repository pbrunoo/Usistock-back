...
exports.UpdateConsumoService = void 0;
const common_1 = require("@nestjs/common");
const consumo_repository_1 = require("../repositories/consumo.repository");
let UpdateConsumoService = class UpdateConsumoService {
    constructor(consumoRepository) {
        this.consumoRepository = consumoRepository;
    }
    async update(produtoId, updateConsumoRequest) {
        try {
...
UpdateConsumoService = __decorate([
    common_1.Injectable(),
...
//# sourceMappingURL=update-consumo.service.js.map