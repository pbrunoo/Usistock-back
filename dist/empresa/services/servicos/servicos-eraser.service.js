...
exports.ServicosEraserService = void 0;
const common_1 = require("@nestjs/common");
const empresa_respository_1 = require("../../repositories/empresa.respository");
let ServicosEraserService = class ServicosEraserService {
    constructor(empresaRepository) {
        this.empresaRepository = empresaRepository;
    }
    async erase(empresaId, cnae) {
...
ServicosEraserService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [empresa_respository_1.EmpresaRepository])
], ServicosEraserService);
exports.ServicosEraserService = ServicosEraserService;
//# sourceMappingURL=servicos-eraser.service.js.map