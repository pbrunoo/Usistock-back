...
let AuthService = class AuthService {
    constructor(userAutenticationService) {
        this.userAutenticationService = userAutenticationService;
    }
    async validateUser(username, pass) {
        const user = await this.userAutenticationService.findAuth(username);
...
AuthService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [user_authentication_service_1.UserAutenticationService])
], AuthService);
