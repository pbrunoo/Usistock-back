...
exports.CreateEstoqueService = void 0;
const common_1 = require("@nestjs/common");
const estoque_repository_1 = require("../repositories/estoque.repository");
let CreateEstoqueService = class CreateEstoqueService {
    ...
    async create(newEstoqueRequest) {
        try {
            ...
            if (estoque.length > 0) {
                throw new common_1.BadRequestException('Esse produto já existe.');
            }
            console.log(estoque);
...
CreateEstoqueService = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [estoque_repository_1.EstoqueRepository])
], CreateEstoqueService);
exports.CreateEstoqueService = CreateEstoqueService;
//# sourceMappingURL=estoque-create.service.js.map